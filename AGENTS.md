...
Turtlematic is a Minecraft 1.21.1 mod that adds turtle upgrades, peripherals, and mod integrations for CC:Tweaked. It supports both Fabric and NeoForge from a shared core module.

## Tech Stack

- Runtime: Minecraft 1.21.1 / Java 21
- Languages: Kotlin 2.0 and Java
- Loaders: Fabric Loader 0.16 and NeoForge 21.1

...
class ModEnLanguageProvider(output: PackOutput) : ModLanguageProvider(output, "en_us") {
    override fun addTranslations() {
        ...
        addTurtle(AutomataCorePeripheral.upgradeID, "Automata")
        addTurtle(HusbandryAutomataCorePeripheral.upgradeID, "Husbandry Automata")
        addTurtle(EndAutomataCorePeripheral.upgradeID, "End Automata")
        addTurtle(ProtectiveAutomataCorePeripheral.upgradeID, "Protective Automata")

        addTurtle(HusbandryAutomataCorePeripheral.upgradeID.toNetherite(), "Netherite Husbandry Automata")
        addTurtle(EndAutomataCorePeripheral.upgradeID.toNetherite(), "Netherite End Automata")
        addTurtle(ProtectiveAutomataCorePeripheral.upgradeID.toNetherite(), "Netherite Protective Automata")

        addTurtle(HusbandryAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound Husbandry Automata")
        addTurtle(EndAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound End Automata")
        addTurtle(ProtectiveAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound Protective Automata")

        addTurtle(HusbandryAutomataCorePeripheral.upgradeID.toCreative(), "Creative Husbandry Automata")
        addTurtle(EndAutomataCorePeripheral.upgradeID.toCreative(), "Creative End automata")
        addTurtle(ProtectiveAutomataCorePeripheral.upgradeID.toCreative(), "Creative Protective automata")

        addTurtle(EnormousAutomataCorePeripheral.upgradeID, "Enormous Automata")

        addTurtle(BrewingAutomataCorePeripheral.upgradeID, "Brewing Automata")
        addTurtle(SmithingAutomataCorePeripheral.upgradeID, "Smithing Automata")
        addTurtle(EnchantingAutomataCorePeripheral.upgradeID, "Enchanting Automata")
        addTurtle(MasonAutomataCorePeripheral.upgradeID, "Mason Automata")
        addTurtle(MercantileAutomataCorePeripheral.upgradeID, "Mercantile Automata")

        addTurtle(BrewingAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound Brewing Automata")
        addTurtle(SmithingAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound Smithing Automata")
        addTurtle(EnchantingAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound Enchanting Automata")
        addTurtle(MasonAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound Mason Automata")
        addTurtle(MercantileAutomataCorePeripheral.upgradeID.toStarbound(), "Starbound Mercantile Automata")

        addTurtle(BrewingAutomataCorePeripheral.upgradeID.toCreative(), "Creative Brewing Automata")
        addTurtle(SmithingAutomataCorePeripheral.upgradeID.toCreative(), "Creative Smithing Automata")
        addTurtle(EnchantingAutomataCorePeripheral.upgradeID.toCreative(), "Creative Enchanting Automata")
        addTurtle(MasonAutomataCorePeripheral.upgradeID.toCreative(), "Creative Mason Automata")
        addTurtle(MercantileAutomataCorePeripheral.upgradeID.toCreative(), "Creative Mercantile Automata")

        addTurtle(SoulScrapperPeripheral.upgradeID, "Soul scrapping")
        addTurtle(TurtleChatterPeripheral.upgradeID, "Chatting")
        addTurtle(CreativeChestPeripheral.upgradeID, "Creativity")
        addTurtle(PistonPeripheral.upgradeID, "Piston")
        addTurtle(StickyPistonPeripheral.upgradeID, "Sticky Piston")
        addTurtle(LavaBucketPeripheral.upgradeID, "Trashing")

...
abstract class StarboundTurtleUpgrade<T : IOwnedPeripheral<*>> : ClockwiseTurtleUpgrade<T> {
    ...
    companion object {
        fun <T : IOwnedPeripheral<*>> dynamic(id: ResourceLocation, item: BaseAutomataCore, constructor: AutomataPeripheralBuildFunction<T>): StarboundTurtleUpgrade<T> = Dynamic(id, item, constructor)

        fun <T : IOwnedPeripheral<*>> ticker(id: ResourceLocation, item: BaseAutomataCore, constructor: AutomataPeripheralBuildFunction<T>, ticker: AutomataTickerFunction): StarboundTurtleUpgrade<T> = Ticker(id, item, constructor, ticker)
    }

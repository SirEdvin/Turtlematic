...
object ModItemModelProvider {
    ...
    val BASE_GEAR = "base"
    val NETHERITE_GEAR = "nether"
    val STARBOUND_GEAR = "starbound"
    val CREATIVE_GEAR = "creative"
    ...
    fun createAutomataCore(
        ...
        createFlatItem(
            generators,
            item,
            TurtlematicCore.id("item/automata/${fire}_$gear"),
        )
    }
    ...
    fun addModels(generators: ItemModelGenerators) {
        ...
        createFlatItem(generators, Items.FORGED_AUTOMATA_CORE.get(), TurtlematicCore.id("item/netherite_gear"))
